...
export function Win95Window({ title, children, onClose, className = '' }: Win95WindowProps) {
    return (
...
export function Win95Button({ children, onClick, disabled = false, className = '', variant = 'default', ...props }: Win95ButtonProps) {
...
export function Win95ProgressBar({ progress, className = '' }: Win95ProgressBarProps) {
    return (
